...
movement_log_entry = MovementLog(student=student1, location=location1, time_out=datetime.now()time_in=datetime.now()#time
movement_log_entry = MovementLog(student=student2, location=location2, time_out=datetime.now()time_in=datetime.now()#timel
