...
class Student(db.Model):
    ...
    teacher = db.relationship('Teacher', back_populates='students')homeroom_id = db.Column(db.Integer, db.ForeignKey('homeroom.homeroom_id'), nullable=False)
...
class Homeroom(db.Model):#Homeroom =
    ...
    homeroom_id = db.Column(db.Integ, primary_key=True, autoincrment=True) 
